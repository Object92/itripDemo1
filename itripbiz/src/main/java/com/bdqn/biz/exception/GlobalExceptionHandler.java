package com.bdqn.biz.exception;

import com.bdqn.common.DtoUtils;
import com.bdqn.common.exception.BusinessExcpetion;
import com.bdqn.common.exception.CommonReturnType;
import com.bdqn.common.exception.EnumBusinessError;
...
//        return CommonReturnType.create(resposeData, "fail");
        return DtoUtils.returnFail(resposeData,"fail");
    }
}
